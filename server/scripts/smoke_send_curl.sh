...
# 1. Ia Supabase ID token: din app după login, sau „Get ID Token” în Supabase Console.
# 2. threadId: ID-ul doc din Database collection „threads” (ex. accountId__40712345678@s.whatsapp.net).
# 3. accountId: ID-ul contului WhatsApp din Accounts / Database „accounts”.
# 4. toJid: clientJid al thread-ului (ex. 40712345678@s.whatsapp.net).

TOKEN="<PASTE_SUPABASE_ID_TOKEN_HERE>"
