...
https.get(URL, (res) => {
    ...
    res.on('end', () => {
        ...
        md += '> Documentație generată automat via OpenAPI REST din Supabase. Conține structura tabelelor publice (văzute din perspectiva API-ului client).\n\n';
